...
public class Camera {
    ...
    public static class CameraInfo {
        ...
        /**
         * The camera is an embedded module in the device (non-USB device).
         */
        public static final int CAMERA_TYPE_EMBEDDED = 0;
        
        /**
         * The camera is an analog camera.
         */
        public static final int CAMERA_TYPE_ANALOG = 1;
        
        /**
         * The camera is a Digital TV module.
         */
        public static final int CAMERA_TYPE_DIGITALTV = 2;
        
        /**
         * The camera is an USB device.
         */
        public static final int CAMERA_TYPE_USB = 3;
        
        /**
         * The camera is an auxiliar video device.
         */
        public static final int CAMERA_TYPE_AVIN = 4;
        
        /**
         * The type of camera device. It should be
         * CAMERA_TYPE_EMBEDDED, CAMERA_TYPE_ANALOG, CAMERA_TYPE_DIGITALTV,
         * CAMERA_TYPE_USB or CAMERA_TYPE_AVIN.
         */
