...
enum {
    CAMERA_SENSOR_CAMERA = 0, 
    CAMERA_SENSOR_TVIN = 1
};

/**
 * This enum must reflect the constants declared at:
 * frameworks/base/core/java/android/hardware/Camera.java
 */
enum {
    CAMERA_TYPE_EMBEDDED = 0,
    CAMERA_TYPE_ANALOG = 1,
    CAMERA_TYPE_DIGITALTV = 2,
    CAMERA_TYPE_USB = 3,
    CAMERA_TYPE_AVIN = 4,
};
...
struct CameraInfo {
    ...
    /**
     * The type of the camera sensor. It should be
     * CAMERA_SENSOR_CAMERA or CAMERA_SENSOR_TVIN.
     */
    int sensor_type;

    /**
     * The type of camera. It should be CAMERA_TYPE_EMBEDDED,
     * CAMERA_TYPE_ANALOG, CAMERA_TYPE_USB, CAMERA_TYPE_DIGITALTV,
     * or CAMERA_TYPE_AVIN.
     */
    int cameraType;
};
